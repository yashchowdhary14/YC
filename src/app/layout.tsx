          ...
          <SidebarProvider>
            <div className="relative min-h-svh">
              ...
              <div className="fixed left-0 top-0 h-full z-10 hidden lg:flex flex-col border-r bg-background w-72">
                <StyledSidebarHeader>
                  <h1 className="text-2xl font-bold p-2 px-4 font-serif">YC</h1>
                </StyledSidebarHeader>
