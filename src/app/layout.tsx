...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="font-body antialiased overflow-x-hidden bg-background">
        <FirebaseClientProvider>
          <SidebarProvider>
            <div className="relative min-h-svh">
              {/* Desktop Sidebars */}
              <div className="fixed left-0 top-0 h-full z-10 hidden lg:flex flex-col border-r border-border bg-background w-72">
                <StyledSidebarHeader>
