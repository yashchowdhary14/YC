...
<<<<<<< HEAD
    <main className="min-h-screen bg-background pt-14">
      <div className="grid grid-cols-12 border-t h-[calc(100vh-3.5rem)]">
        ...
        <div className="col-span-3 border-l hidden xl:block">
          {selectedChat && selectedChat.userDetails ? (
            <ChatDetails partner={selectedChat.userDetails.find(u => u.id !== user?.uid) || selectedChat.userDetails[0]} />
          ) : (
