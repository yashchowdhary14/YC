...
export default function BroadcastPage() {
  ...
  return (
    <main className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 min-h-[calc(100vh-3.5rem)]">
        ...
        <div className="md:col-span-1 lg:col-span-1 border-l h-[calc(100vh-3.5rem)] hidden md:flex">
