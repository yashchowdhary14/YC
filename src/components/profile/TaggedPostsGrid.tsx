...
const TaggedPostsGrid: React.FC<TaggedPostsGridProps> = ({ userId }) => {
  const { posts, isLoading, isLoadingMore, hasMore, loadMore } = useTaggedPosts(userId);
  ...
  if (posts.length === 0) {
      return (
          <div className="text-center py-16 text-muted-foreground flex flex-col items-center gap-4">
              ...
              <p>When this user is tagged in posts, they will appear here.</p>
          </div>
      )
  }
