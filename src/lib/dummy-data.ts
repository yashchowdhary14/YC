...
export let dummyLiveBroadcasts: LiveBroadcast[] = [
    ...
    { id: 'live_sakshi', streamerId: 'user_sakshi', streamerName: 'sakshi', user: getHydratedUser('user_sakshi'), title: 'Workout Session', category: 'Fitness', isLive: true, viewerCount: 52000, liveThumbnail: 'https://picsum.photos/seed/stream_sakshi/640/360', streamUrl: 'https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4' },
    { id: 'live_lila', streamerId: 'user_wanderlust_lila', streamerName: 'wanderlust_lila', user: getHydratedUser('user_wanderlust_lila'), title: 'Exploring Tokyo', category: 'Travel', isLive: false, viewerCount: 0, liveThumbnail: 'https://picsum.photos/seed/stream_lila/640/360', streamUrl: 'https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4' },
    { id: 'live_ethan', streamerId: 'user_ethan_bytes', streamerName: 'ethan_bytes', user: getHydratedUser('user_ethan_bytes'), title: 'Coding a new project', category: 'Tech', isLive: true, viewerCount: 1200, liveThumbnail: 'https://picsum.photos/seed/stream_ethan/640/360', streamUrl: 'https://storage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4' },
    { id: 'live_maya', streamerId: 'user_maya_creates', streamerName: 'maya_creates', user: getHydratedUser('user_maya_creates'), title: 'Live Painting Session', category: 'Art', isLive: true, viewerCount: 9800, liveThumbnail: 'https://picsum.photos/seed/stream_maya/640/360', streamUrl: 'https://storage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4' },
    { id: 'live_sam', streamerId: 'user_sam_reviews', streamerName: 'sam_reviews', user: getHydratedUser('user_sam_reviews'), title: 'Unboxing the new phone!', category: 'Tech', isLive: false, viewerCount: 0, liveThumbnail: 'https://picsum.photos/seed/stream_sam/640/360', streamUrl: 'https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4' },
];
